...
CREATE OR REPLACE WAREHOUSE dv_lab_wh 
WITH WAREHOUSE_SIZE = 'XSMALL' 
MIN_CLUSTER_COUNT = 1 MAX_CLUSTER_COUNT = 1 
AUTO_SUSPEND = 300 COMMENT = 'Generic WH';

CREATE OR REPLACE WAREHOUSE dv_rdv_wh 
WITH WAREHOUSE_SIZE = 'XSMALL' 
MIN_CLUSTER_COUNT = 1 MAX_CLUSTER_COUNT = 1 
AUTO_SUSPEND = 300 COMMENT = 'WH for Raw Data Vault object pipelines';

--CREATE OR REPLACE WAREHOUSE dv_bdv_wh 
-- WITH WAREHOUSE_SIZE = 'XSMALL' 
-- MIN_CLUSTER_COUNT = 1 MAX_CLUSTER_COUNT = 1 
-- AUTO_SUSPEND = 60 COMMENT = 'WH for Business Data Vault object pipelines';

--CREATE OR REPLACE WAREHOUSE dv_id_wh  
-- WITH WAREHOUSE_SIZE = 'XSMALL' 
-- MIN_CLUSTER_COUNT = 1 MAX_CLUSTER_COUNT = 1 
-- AUTO_SUSPEND = 60 COMMENT = 'WH for information delivery object pipelines';
